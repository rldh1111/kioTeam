...
<body>
	...
	<form action="productModify" method="post">
		<table>
			<tr>
				<td>productId</td>
				<td><input type="text" name="productId" value="${modReq.productId }" required readonly></td>
			</tr>
			
			<tr>
				<td>name</td>
				<td><input type="text" name="productName" value="${modReq.productName }" required></td>
			...
			<tr>
				...
				<option value="${modReq.type }">${modReq.type }</option>
					<option value="notebook">저장장치</option>
			...
			<tr>
				...
				<td><select name ="productType">
					<option value="${modReq.productType }">${modReq.productType }</option>
					...
					<option value="s;ap">초경량 노트북</option>
