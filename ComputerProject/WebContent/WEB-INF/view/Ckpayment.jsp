					...
					<c:forEach var="shopping" items="${shoppingPage.spList}">
						<tr>
							<form action="shopping" method="post">
								<td style="text-align: center" readonly="readonly">${shopping.productType }</td>
								<td style="text-align: center" readonly="readonly">${shopping.productname }</td>
								<td style="text-align: center" id="price" readonly="readonly">${shopping.price }</td>
								<td style="text-align: center" readonly="readonly"><input
									style="text-align: center;" id="count" type="text"
									 value="${shopping.count }" readonly="readonly"></td>
								${sum = sum+(shopping.price*shopping.count); ''} ${result += shopping.productname.toString()}
						</tr>
